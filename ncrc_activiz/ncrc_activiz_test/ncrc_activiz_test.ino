...
// Progress bar
ProgressBarSine pBarSine = ProgressBarSine(red, prettyblue);

// RandomMarquee Pattern
RandomMarquee randomMarquee = RandomMarquee();

// Sine Wave Pattern
PatternSineWave patternSineWave = PatternSineWave(purple);

// ColorChangingColumn Pattern
PatternChangingColorColumn patternChangingColorColumn = PatternChangingColorColumn(red);
...
//    Serial.println("--end--");
  ...
  pBarSine.updateSine();
  pBarSine.apply(ledStrips[0].getColors());
