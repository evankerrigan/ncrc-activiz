...
void setLevel(byte level) {
  ...
  scale = 0.55 + 0.45*sin( ( float(currentSampleIndex)*wavePeriod/float(numOfSamples)));
  scale2 =  0.55 + 0.45*sin( ( float(currentSampleIndex)*wavePeriod/float(numOfSamples)) + PI );
